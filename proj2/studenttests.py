...
class TestAbsLoss(unittest.TestCase):
    def test_simple(self):
        ...
        t.check_array(array2, [2, 4, 6, 8, 10])
...
class TestSquaredLoss(unittest.TestCase):
    def test_simple(self):
        ...
        t.call("squared_loss")
        # check that the result array contains the correct output
        t.check_array(array2, [4, 16, 36, 64, 100])
        # check that the register a0 contains the correct output
        t.check_scalar("a0", 220)
...
class TestZeroOneLoss(unittest.TestCase):
    def test_simple(self):
        ...
        # check that the result array contains the correct output
        t.check_array(array2, [1, 0, 1, 0, 1])
...
class TestInitializeZero(unittest.TestCase):
    def test_simple(self):
        ...
        t.check_array_pointer("a0", length*[0])
        t.execute()
    ...
    def test_malloc_fail(self):
        ...
        length = 1073741824  # large number to cause malloc to fail
        t.input_scalar("a0", length)
        t.call("initialize_zero")
        t.execute(code=26)
